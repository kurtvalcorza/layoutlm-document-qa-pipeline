...
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/layoutlm_document_qa_train.jsonl",
    "outputs/layoutlm_document_qa_input_manifest.json",
    "outputs/layoutlm_document_qa_evaluation_report.json",
    "outputs/layoutlm_document_qa_answers.csv",
    "outputs/layoutlm_document_qa_annotated.png",
    "outputs/layoutlm_document_qa_adapter",
    "outputs/layoutlm_document_qa_result.json",
)
CODE_MARKERS = (
    # Stage 4: pinned corpus column, page-disjoint split, validation, JSONL, refusal probes
    "USE_BYOD = False",
...
MARKDOWN_MARKERS = (
    "**Capability:** extractive document question answering over OCR words and boxes and bounded supervised fine-tuning",
    "**MIT**",
    "**The model never sees pixels:**",
    "**adaptation with gold spans**",
    "**CC BY 4.0**",
    "**product of the start and end softmax probabilities of the chosen span within its window**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    113_419_976: "fine-tuned adapter.safetensors size, Kaggle run v2 (run record)",
    234_202_795: "naver-clova-ix/cord-v2 7f0115a data/test-00000-of-00001-9c204eb3f4e11791.parquet",
    242_080_800: "naver-clova-ix/cord-v2 7f0115a data/validation-00000-of-00001-cc3c5779fe22e8ca.parquet",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "0d0f6dac11fdcc549de2746aa9f53136a3bc22a2a1aff2b0b847f7622ad60c15": "naver-clova-ix/cord-v2 7f0115a data/validation-00000-of-00001-cc3c5779fe22e8ca.parquet",
    "51c65f1788faff392abe2a0b55b023eb23e9be551c509138eaa3a832514224e7": "naver-clova-ix/cord-v2 7f0115a data/test-00000-of-00001-9c204eb3f4e11791.parquet",
    "adf8303ec0295af1ef11a63dd0b72453e95399cfd2cd76e3d494c284730bdef9": "column_digest of the cord-v2 validation ground_truth column (canonical JSON of rows)",
    "b499e58aa298e5242b5222b7e333e92e6affb79a192def149d0a0aac3e41d9f1": "column_digest of the cord-v2 test ground_truth column (canonical JSON of rows)",
}
